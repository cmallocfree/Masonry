Pod::Spec.new do |s|
  ...
  s.ios.deployment_target = '9.0' # minimum SDK with autolayout & layoutguide
  s.osx.deployment_target = '10.11' # minimum SDK with autolayout & layoutguide
  s.tvos.deployment_target = '9.0' # minimum SDK with autolayout & layoutguide
  s.requires_arc = true
end
